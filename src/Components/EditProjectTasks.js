...
import {  EDIT_PROJECT_TASK_QUERY  } from "../queries";
import { EDIT_PROJECT_TASK } from "../store/action/type";
import { TodoContext } from "../App";


function EditProjectTask({ task, setEditTask, setIsLoading }) {
  ...
  const [editTask, { loading, error }, editedTask] = useMutation(
    EDIT_PROJECT_TASK_QUERY ,
    {
      update: (
        ...
        context.dispatch({ type: EDIT_PROJECT_TASK, payload: returning[0] });
        setEditTask(null);
        setIsLoading(false);
      },
    }
